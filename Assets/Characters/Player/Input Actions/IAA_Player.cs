...
public partial class @IAA_Player: IInputActionCollection2, IDisposable
{
    ...
    ~@IAA_Player()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, IAA_Player.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, IAA_Player.UI.Disable() has not been called.");
    }
